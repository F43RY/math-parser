...
*
*/
class PipeNodeFactory implements ExpressionNodeFactory
{
    use Sanitize;
    use Numeric;
    ...
    */
    ...
    /** Simplify | node when operands are numeric
    *
    ...
    */
    ...
    {
        $leftOperand = ($this->isNull($leftOperand))? 0 : $leftOperand; 
        $rightOperand = ($this->isNull($rightOperand))? 0 : $rightOperand;
